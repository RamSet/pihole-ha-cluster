...
SYNC_BLOB_DIR=${PIHOLE_HA_BLOB_DIR:-/var/lib/pihole-ha}
HA_NODES=${PIHOLE_HA_NODES}
AUTH_TIMEOUT=${PIHOLE_HA_AUTH_TIMEOUT:-10}
AUTH_RETRY_SEC=${PIHOLE_HA_AUTH_RETRY_SEC:-60}
CHECK_INTERVAL=${PIHOLE_HA_CHECK_INTERVAL:-10}
HEALTH_TIMEOUT=${PIHOLE_HA_HEALTH_TIMEOUT:-2}
ACTIVATE_AFTER=${PIHOLE_HA_ACTIVATE_AFTER:-2}
DEACTIVATE_AFTER=${PIHOLE_HA_DEACTIVATE_AFTER:-3}
STANDBY_ONLY=${PIHOLE_HA_STANDBY_ONLY:-false}
EOF
